    ...
    return (
        <div className='space-y-4 mb-7.5 border border-slate-200 rounded-md'>
            ...
            <div className='px-5 flex flex-col gap-6 justify-center'>
                ...
                <p className='line-clamp-4 text-[#706F6F]'>{news.details}</p>
                <Link href={`/news/${news._id}`}><button className='text-[#FF8C47] font-semibold hover:cursor-pointer'>Read More</button></Link>
